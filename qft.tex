...
\end{align}
It is worth to mention that here the signs for roots symbols correspond with the sign of the imaginary part, not with the real part (i.e. there are oposit to sign of real part). Indeed, since angle $-\omega_\epsilon/2$ is under real axis and $-(\pi + \omega_\epsilon/2)$ is above, we have
\begin{align}
...
= \int_{-\infty}^\infty \cfrac{dp^0}{2\pi i} \cfrac{e^{-ip^0z^0}}{(p^0 - E^{+}_{\bs{p}, \epsilon})(p^0 - E^{-}_{\bs{p}})},
\end{equation}
