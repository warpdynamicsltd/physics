...
\begin{definition}[Bozon creation and anihilation assumptions]
We will call the bellow statements \textit{bozon creation and anihilation assumptions}
\begin{align}
...
\begin{proposition}
We assume bozonic creation and anihilation assumptions. Let $P = \int dp pa^\dagger_p a_p$ and
\begin{equation}
\hat{V} = \int dp_1 dp_2 dq V_q a^\dagger_{p_1 + q} a^\dagger_{p_2 - q} a_{p_2}a_{p1}, 
\end{equation}
then $[\hat{V}, P] = 0.$
\end{proposition}
\begin{proof}
