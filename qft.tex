...
\end{equation}
We assume that left side acts on differentiable ``in a good enough sense'' $\phi:\R^4 \to \C^n$, where $n$ is not necessarily determined yet and $\gamma^\mu$ is a matrix (i.e. $\gamma^\mu\in M_n(\C))$.
