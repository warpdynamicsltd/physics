...
The following Corollary shows how multidimentional Weyl transform acts on multilinear polynomials.
...
\int_{\R^L}
\prod_{r=1}^L e^{-ix_ru_r}du_r\, \prod_{r=1}^L u_r^{n_r} = \prod_{r=1}^L A_{r}^{:n_{r}}.
\end{align*}
\end{corollary}
\begin{proof}
