...
Moreover, we require
\begin{equation}
S^2 \vcentcolon= S^2_x + S^2_y + S^2_x = (s + 1)s,  
\end{equation}
for certain $s > 0$.
...
\begin{fact}
If $\ket{\phi} \not= 0$ such that $S_z\ket{\phi} = m\ket{\phi}$, then
\begin{equation}
...
\begin{corollary}
If $\ket{\phi} \not= 0$ such that $S_z\ket{\phi} = m\ket{\phi}$
and $m \not= -s$, then 
\begin{equation}
S_z^{-}\ket{\phi} \not= 0.
\end{equation}
...
\begin{corollary}
If there exists $\ket{\phi} \not= 0$ such that $S_z\ket{\phi} = m\ket{\phi}$,
we have $\ket{\psi} \not= 0$ such that
\begin{equation}
S_z \ket{\psi} = s \ket{\psi}
\end{equation}
and
\begin{equation}
S^{+}_z \ket{\psi} = 0.
...
\begin{fact}
If there exists $\ket{\phi} \not= 0$ such that $S_z\ket{\phi} = m\ket{\phi}$, then there exists such an integer $k$ such that $s = \cfrac{k}{2}$ and
the spectrum of $S_z$ is $\{-s, -s + 1, \dots, s - 1, s\}$.
\end{fact}
