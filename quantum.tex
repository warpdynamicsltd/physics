...
Let $V$ be an abstract vector space over field $\C$ and $V^*$ be a space of all linear functionals on $V$. We will assume convetion in which elements of a vector space $V$, will be denoted as kets $\ket{\psi}\in V$ and elements of a dual space $V^*$ will be dentones as bra $\bra{\phi}\in V^*$.
...
If we have $V\subset H$, we can identify $\ket{\phi}\in V$ with a certain element of $H$ understood as a subset of $V^*$ in a following way
\begin{equation}
