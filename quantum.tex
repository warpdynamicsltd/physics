...
Thus
\begin{equation}
\bra{\phi_\beta}U (-\infty, t) \ket{\phi_\alpha} = \delta(\beta - \alpha) + \cfrac{e^{-it(\omega_{\alpha\beta} +in\eepsilon)}}{\omega_{\alpha\beta}+in\eepsilon } \bra{\phi_\beta}T \ket{\phi_\alpha}.
\end{equation}
