...
\end{equation}
thus $|C(p_1)| = 1$. Then $C(p)$ is simply a space shift, so we could always choose base $\ket{p}$ in a way that $C(p) = 1$. We will assume that this is our standard base choice.
