...
\end{equation}
and hence thesis.
For $a < 0$, the proof is analogous, with the difference that we would use a half-circle $\Gamma_{-R}: \theta \mapsto Re^{i\theta}$ for $\theta\in[\pi, 2\pi]$ and apply Corollary \ref{jordan-lemma-cor}.
\end{proof}
